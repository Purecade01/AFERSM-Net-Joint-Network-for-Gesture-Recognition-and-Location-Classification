...
# aplnet = MLSTMfcn(num_classes_act=6,
#                   num_classes_loc=16,
#                                max_seq_len=192,
#                                num_features=52)
# aplnet = MACNN(in_channels=1, channels=64,  num_classes_act=6, num_classes_loc=16, block_num=None)
...
# optimizer = torch.optim.Adam(aplnet.parameters(), lr=0.006)
optimizer = optim.AdamW(aplnet.parameters(), lr=0.0001)
