...
print('the train_data shpe[0] is:',train_data.shape[0])
print('the train_data shpe[1] is:',train_data.shape[1])
...
optimizer = torch.optim.Adam(aplnet.parameters(), lr=0.009)
